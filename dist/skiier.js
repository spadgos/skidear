...
export var SkiierState;
(function (SkiierState) {
    SkiierState[SkiierState["SKIING"] = 0] = "SKIING";
    SkiierState[SkiierState["CRASHED"] = 1] = "CRASHED";
    SkiierState[SkiierState["AIRBORNE"] = 2] = "AIRBORNE";
    SkiierState[SkiierState["EATEN"] = 3] = "EATEN";
})(SkiierState || (SkiierState = {}));
...
export class Skiier extends ImageSprite {
    ...
    onCollision(other) {
        if (this.state !== SkiierState.SKIING)
            return;
    ...
    onBeforeRender(event) {
        ...
        const angle = this.angle =
            clamp(this.angle - turnSpeedLimit, easeTo(this.angle, this.targetAngle, TURN_SPEED, 0.01), this.angle + turnSpeedLimit);
        ...
        this.setPos(x + xComponent * this.speed * secondsElapsed, y + yComponent * this.speed * secondsElapsed, newZ);
    }
    ;
    setTargetAngle(rads) {
...
//# sourceMappingURL=skiier.js.map